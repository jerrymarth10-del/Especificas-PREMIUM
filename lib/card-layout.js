...
function applyCardLayout(html) {
  ...
  const css = `<style id="jr-card-layout-v1">
    .cards .jr-repaired-card{background:#050609;min-width:0}
    .cards .jr-repaired-card img{object-fit:contain!important;object-position:center!important;transform:none!important}
  ...
  return repairRadiologia(html);
}

module.exports = { applyCardLayout, repairRadiologia };
